              ...
              <div class="col-md-6">
                <div class="mb-15">
                  <button id="addToTable" class="btn btn-outline btn-primary" type="button">
                    <i class="icon wb-plus" aria-hidden="true"></i>ครุภัณฑ์
                  </button>
                </div>
              </div>
            </div>
              ...
              ?>
                ...
                <td>
                  ...
                  "<td class='actions'>
                    ...
                    <a href='form_del_db.php?ID=$row[0]' class='btn btn-sm btn-icon btn-pure btn-default on-editing' data-original-title='แก้ไข้'>
